...
STAGE2_HISTORY_LOSS="${TRAIN_STAGE2_TAIL_HISTORY_LOSS:-${TRAIN_TAIL_HISTORY_LOSS:-coeff}}"
STAGE2_HISTORY_XV_GRID="${TRAIN_STAGE2_TAIL_HISTORY_XV_GRID:-${TRAIN_TAIL_HISTORY_XV_GRID:-512}}"
...
env \
  ...
  TRAIN_TAIL_HISTORY_LOSS="${STAGE2_HISTORY_LOSS}" \
  TRAIN_TAIL_HISTORY_XV_GRID="${STAGE2_HISTORY_XV_GRID}" \
...
Stage 2 hist loss:  ${STAGE2_HISTORY_LOSS}
Stage 2 xv grid:    ${STAGE2_HISTORY_XV_GRID}
