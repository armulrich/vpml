...
RESOLUTION_NV_LIST="${RESOLUTION_NV_LIST:-512,1024,2048,4096,8192,16384}"
PHYSICAL_NV_LIST="${PHYSICAL_NV_LIST:-${RESOLUTION_NV_LIST}}"
...
PROJECTION_QUADRATURE_NV_LIST="${PROJECTION_QUADRATURE_NV_LIST:-${RESOLUTION_NV_LIST}}"
