#!/bin/bash
#SBATCH --job-name=fig2_cpu
#SBATCH --output=fig2_cpu_%A.out
#SBATCH --error=fig2_cpu_%A.err
...
# ============================================================================
# Run Fig. 2 benchmark (damping profiles) on CPU and print wall-clock time.
# ============================================================================
#
# Usage (from vpml repo root):
#   sbatch benchmarks/job_fig2_cpu_timed.sh
#   sbatch benchmarks/job_fig2_cpu_timed.sh /path/to/outdir
# ============================================================================
...
echo "=============================================="
echo "Fig. 2 benchmark (CPU, timed)"
echo "Repo: $VPML_ROOT"
echo "Python: $PYTHON"
echo "Output: $OUT_DIR"
echo "=============================================="

time bash "$VPML_ROOT/benchmarks/run_fig_cpu_timed.sh" fig2 "$OUT_DIR"
EXIT_CODE=$?
echo ""
